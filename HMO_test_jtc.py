...
frame1 = visual.Rect(myWin, lineWidth=9, lineColor=[1,0,0], fillColor=None)
#frame2 = visual.Rect(myWin, lineWidth=3, lineColor=[0,1,0], fillColor=None)
frame2 = visual.Rect(myWin, lineWidth=12, lineColor=[0,1,0], fillColor=None)
#frame3 = visual.Rect(myWin, lineWidth=3, lineColor=[0,0,1], fillColor=None)
frame3 = visual.Rect(myWin, lineWidth=15, lineColor=[0,0,1], fillColor=None)

box1 =visual.Rect(myWin, pos=[-200,-200], width=20, height=20, lineWidth=3, lineColor=[1,0,0], fillColor=[58,51,60])

#box2 =visual.Rect(myWin, pos=[0,-100], width=20, height=20, lineWidth=3, lineColor=[0,1,0], fillColor=None)
box2 =visual.Rect(myWin, pos=[100,-100], width=40, height=40, lineWidth=3, lineColor=[1.0,-1,-1], fillColor=None)
#box3 =visual.Rect(myWin, pos=[200,0],width=20, height=20, lineWidth=3, lineColor=[0,0,1], fillColor=None)
box3 =visual.Rect(myWin, pos=[300,0],width=90, height=120, lineWidth=3, lineColor=[1.0,0.6,0.6], fillColor=None)
